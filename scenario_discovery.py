...
# Define X and Y
x = filtered_experiments.iloc[:, 0:25]
names_list = ['celc', 'heat_pump', 'i']  # This is essentially "constrained PRIM"
x = x[names_list]
...
prim_alg = prim.Prim(x, y, threshold=0.4, peel_alpha=0.1) # Threshold was 0.8 before (Kwakkel) #NOTE: To avoid deprecated error, I replaced line 1506 in prim.py with: np.int(paste_value) => int(paste_value)
