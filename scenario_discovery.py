...
names_list = ['celc', 'SupplyStrategy', 'rate']  # This is essentially "constrained PRIM"
x = x[names_list]
y = (filtered_outcomes["capture_cost"] < 90) & (filtered_outcomes["penalty_services"] < 450) & (filtered_outcomes["penalty_biomass"] < 200)
