# TODO: (1) Test EMA Sobol first, (2) Try CATEGORICAL uncertainties, (3) Try MIXING uncertainties and levers of categorical/integer etc., (4) Try adapting to BINARY output
# https://salib.readthedocs.io/en/latest/user_guide/basics.html REFERENCE FOR SOBOL SALIB
"""
...
if __name__ == "__main__":
    ...
    n_scenarios = 1000 # NOTE: SOBOL sampler generates n=n_scenarios*(2D+2) samples, where D=n_model inputs, I think

    # results = perform_experiments(n_scenarios, policy, uncertainty_sampling=Samplers.SOBOL)
    results = perform_experiments(lake_model, n_scenarios, policies=policy, uncertainty_sampling = Samplers.SOBOL)
