...
# (6) Determine available heat from:
...
# (7) Now we manage Qreb by assuming an EnergyPriority = MaximizeTurbineUse (always run steam through turbines) or MinimizeFuelUse (avoid using additional biomass) NOTE: We chose this deliberately to reveal tensions between KPI2 and KPI3.
